...
import { Facebook, Instagram, Linkedin, Mail, MessageCircle, Users } from 'lucide-react'
    ...
    <div className="min-h-screen bg-purple-main text-cream">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 lg:px-12 bg-purple-main border-b border-purple-light/10">
        ...
        <div className="hidden md:flex items-center space-x-8 text-cream font-inter">
          ...
          <a href="/kontakt" className="text-yellow-accent transition-colors">KONTAKT</a>
      ...
      <section className="px-6 pb-16 lg:px-12 bg-purple-main">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#FFFBEB]/15 border border-purple-light/20 p-8 rounded-2xl hover:border-yellow-accent/50 transition-colors group">
            ...
            <h3 className="text-2xl font-bold font-nasalization text-white mb-2">Discord – naše hlavní základna</h3>
            <p className="font-inter text-cream/80 mb-6">
              Nejrychlejší cesta k nám. Komunita, podpora, novinky a lidé, co řeší podobné věci jako ty.
            </p>
            <a href="https://naucme.it/discord" className="inline-flex items-center gap-2 text-yellow-accent font-bold hover:text-white transition-colors">
          ...
          <div className="bg-[#FFFBEB]/15 border border-purple-light/20 p-8 rounded-2xl hover:border-yellow-accent/50 transition-colors group">
            ...
            <h3 className="text-2xl font-bold font-nasalization text-white mb-2">Facebook – novinky & akce</h3>
            <p className="font-inter text-cream/80 mb-6">
              Streamy, komunitní eventy a užitečný obsah, který ti pomůže držet krok.
            </p>
            <a href="https://www.facebook.com/NaucMeIT/" className="inline-flex items-center gap-2 text-yellow-accent font-bold hover:text-white transition-colors">
          ...
          <div className="bg-[#FFFBEB]/15 border border-purple-light/20 p-8 rounded-2xl hover:border-yellow-accent/50 transition-colors group">
            ...
            <h3 className="text-2xl font-bold font-nasalization text-white mb-2">LinkedIn – pro kariérní růst</h3>
            <p className="font-inter text-cream/80 mb-6">
              Profesionální tipy, zákulisí, příležitosti a vhledy ze světa technologií.
            </p>
            <a href="https://www.linkedin.com/company/nauc-me-it" className="inline-flex items-center gap-2 text-yellow-accent font-bold hover:text-white transition-colors">
          ...
          <div className="bg-[#FFFBEB]/15 border border-purple-light/20 p-8 rounded-2xl hover:border-yellow-accent/50 transition-colors group">
            ...
            <h3 className="text-2xl font-bold font-nasalization text-white mb-2">Instagram – Entership vibe</h3>
            <p className="font-inter text-cream/80 mb-6">
              Backstage, memy, rychlé tipy a kousek našeho nerdího světa.
            </p>
            <a href="#" className="inline-flex items-center gap-2 text-yellow-accent font-bold hover:text-white transition-colors">
      ...
      <section className="px-6 pb-16 lg:px-12 bg-purple-main">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#FFFBEB]/15 border border-white rounded-lg p-12 text-center">
            ...
            <h2 className="text-3xl font-nasalization font-bold text-white mb-4">Email</h2>
            <p className="font-inter text-cream/80 mb-6">Na dotazy, spolupráce i partnerships:</p>
            <a href="mailto:hello@entership.cz" className="text-2xl md:text-4xl font-bold text-[#4DEEEA] hover:text-white transition-colors">
              hello@entership.cz
            </a>
          </div>
        </div>
      ...
      <section className="px-6 pb-24 lg:px-12 bg-purple-main text-center">
        <div className="max-w-2xl mx-auto">
          <h3 className="text-xl font-nasalization font-bold text-yellow-accent mb-4">Malý dovětek</h3>
