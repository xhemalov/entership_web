    ...
    <footer className="px-6 py-16 lg:px-12 bg-purple-main border-t border-purple-light/20">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            <h3 className="text-cream font-nasalization font-bold text-xl mb-6 leading-normal-xl">ENTERSHIP</h3>
          ...
          <div>
            <h4 className="text-cream font-inter font-semibold mb-4 leading-relaxed-xl">Rychlé odkazy</h4>
            <ul className="space-y-2 text-purple-200 font-inter text-sm">
          ...
          <div>
            <h4 className="text-cream font-inter font-semibold mb-4 leading-relaxed-xl">Kontakt</h4>
            <div className="space-y-2 text-purple-200 font-inter text-sm">
              <p>info@aikurzy.cz</p>
              <p>+420 123 456 789</p>
